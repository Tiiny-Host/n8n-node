...
export async function executeUpdate(
	...
	// Example: teal-darryl-81.tiiny.site → subdomain: teal-darryl-81, domainSuffix: .tiiny.site
	const parseLinkParts = (siteLink: string) => {
	...
	const { subdomain, domainSuffix } = parseLinkParts(link);
